...
# rsl-rl
from rsl_rl.modules import StudentTeacher, StudentTeacherRecurrent, StudentTeacherPointNet
...
class Distillation:
    ...
    policy: StudentTeacher | StudentTeacherRecurrent | StudentTeacherPointNet
